...
Reponse Object:
```json
{"response":{"data":{"role":3,"siteName":"Egen Test","accessToken":"070B4B08-D4AE-52AA-D074BB2E9F4D49EE","securityorganization":"","loginTime":"08\/30\/2017 11:12 AM","expireTime":240,"siteId":134,"securityname":"egen test"},"returnCode":200,"isSuccess":true}}
```
...
Request Method: `POST`
Request Header: `Authorization: egen@072B2066-D4AE-52AA-D07417EC03A53B99`	// Format for authorization header is userid@accessToken
...
Note: This will only be used when the device is actively connected to the internet
